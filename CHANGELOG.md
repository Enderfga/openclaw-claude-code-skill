...
### Added
- **JSDoc documentation** — public API documented across SessionManager, PersistentClaudeSession, PersistentCodexSession, PersistentGeminiSession, PersistentCursorSession, and types.ts

### Fixed
- **JSDoc accuracy** — fixed mismatched @param/@returns tags, duplicate doc blocks, incorrect cwd defaults, and engine-specific descriptions in SessionManager and PersistentClaudeSession
